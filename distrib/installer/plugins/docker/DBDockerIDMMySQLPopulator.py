# installer plugin Docker idm MySQL db initiator
#
...
class DBDockerIDMMySQLPopulator(AMySQLdbInit):
    ...
    def __init__(self, db_config):
        ...
        self.sqlScriptFilePath = "resources/sqlscripts/plugins/docker/idm_plugin_docker_insert.sql"

    def process(self):
        return super(DBDockerIDMMySQLPopulator, self).process()
